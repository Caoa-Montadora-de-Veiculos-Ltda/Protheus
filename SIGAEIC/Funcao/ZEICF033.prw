...
IF SF1->F1_EST= 'EX' 
    ...
    IF !Empty(cChassi) .AND. !Empty(cHAWB) .AND. cTipo == 'I' 
		...
		SELECT SD1.D1_FILIAL AS CD9_FILIAL, SD1.D1_ITEM AS CD9_ITEM, SD1.D1_COD AS CD9_COD, SD1.D1_CHASSI AS CD9_CHASSI,;
			VV1.VV1_SERMOT AS CD9_SERIAL, VV1.VV1_NUMMOT AS CD9_NMOTOR, Substr(VV1.VV1_FABMOD,1,4) AS CD9_ANOFAB, Substr(VV1.VV1_FABMOD,5,4) AS CD9_ANOMOD,;
		...
		If (cAliasCD9)->(!EOF())
		    ...
		    CD9->CD9_SERIAL := (cAliasCD9)->CD9_SERIAL                //Serial (série)
			CD9->CD9_NMOTOR := (cAliasCD9)->CD9_NMOTOR                //Numero Motor
