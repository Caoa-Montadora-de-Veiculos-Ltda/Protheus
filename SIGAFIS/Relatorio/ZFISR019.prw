...
Static Function fReportDef()
    ...
    TRCell():New( oSection1, "DT_SAIDA"       , cAliasTMP, "DATA DE ENTRADA"  , PesqPict("SF3", "F3_ENTRADA"), TamSx3("F3_ENTRADA")[1] , /*lPixel*/, /*{|| code-block de impressao }*/, "LEFT", /*lLineBreak*/, "LEFT", /*lCellBreak*/, /*nColSpace*/, /*lAutoSize*/, /*nClrBack*/, /*nClrFore*/, .F.)
...
Static Function  ReportPrint(oReport)
    ...
    cQuery += "         , SF2.F2_EMISSAO AS DT_SAIDA"                   + CRLF
	...
	cQuery += "  	, NOTA_FISCAL, SERIE, CHAVE, DT_SAIDA  "            + CRLF
    ...
    cQuery += "    AND SF3.F3_EMISSAO = NOTA.DT_SAIDA "                 + CRLF
    ...
    While (cAliasTMP)->(!EoF()) .And. !oReport:Cancel()
        ...
        oSection1:Cell("EMISSAO"):SetValue(StoD((cAliasTMP)->DT_SAIDA))
        ...
        If (cAliasTMP)->F3_DTCANC != ' '
            ...
            oSection2:Cell("EMISSAO"):SetValue(StoD((cAliasTMP)->DT_SAIDA))
