...
User Function ZFISR019()
    ...
    aAdd(aPergs, {1,"Saída de?"			,dDtEmiss	,/*Pict*/	,/*Valid*/	,/*F3*/		,/*When*/,50,.F.})  //MV_PAR01
	aAdd(aPergs, {1,"Saída ate?"		    ,dDtEmiss	,/*Pict*/,MV_PAR02 > MV_PAR01,/*F3*/,/*When*/,50,.F.})  //MV_PAR02
...
Static Function fReportDef()
	...
	oSection1 := TRSection():New(oReport    ,"Colunas"    ,{cAliasTMP}) 
