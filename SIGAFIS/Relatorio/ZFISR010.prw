...
User Function ZFISR010()
    ...
    //TRCell():New( oSection  ,"BasePisImp"   ,cAliasTMP  ,'Base PIS Importação'            )
    //TRCell():New( oSection  ,"AliqPisImp"   ,cAliasTMP  ,'Aliq. PIS Importação'           )
    //TRCell():New( oSection  ,"FT_MVALPIS"   ,cAliasTMP  ,'Valor PIS Importação'           )
    //TRCell():New( oSection  ,"BaseCofImp"   ,cAliasTMP  ,'Base Cofins Importação'         )
    //TRCell():New( oSection  ,"AliqCofImp"   ,cAliasTMP  ,'Aliq. Cofins Importação'        )
    //TRCell():New( oSection  ,"FT_MVALCOF"   ,cAliasTMP  ,'Valor Cofins Importação'        )
...
Static Function  ReportPrint(oReport)
    ...
    While (cAliasTMP)->(!EoF()) .And. !oReport:Cancel()
        ...
        zRel0003(@nVlIPIRegi, @nVlIPIPres, (cAliasTMP)->F1_ESPECIE, (cAliasTMP)->F1_DOC, (cAliasTMP)->F1_SERIE,;
         ...
         //oSection:Cell( "BasePisImp"):SetValue( (cAliasTMP)->D1_BASIMP6 ) //--Base PIS Importação
         //oSection:Cell( "AliqPisImp"):SetValue( (cAliasTMP)->D1_ALQIMP6 ) //--Aliq. PIS Importação
         //oSection:Cell( "FT_MVALPIS"):SetValue( (cAliasTMP)->FT_MVALPIS ) //--Valor PIS Importação
         //oSection:Cell( "BaseCofImp"):SetValue( (cAliasTMP)->D1_BASIMP5 ) //--Base Cofins Importação
         //oSection:Cell( "AliqCofImp"):SetValue( (cAliasTMP)->D1_ALQIMP5 ) //--Aliq. Cofins Importação
         //oSection:Cell( "FT_MVALCOF"):SetValue( (cAliasTMP)->FT_MVALCOF ) //--Valor Cofins Importação
