...
Static Function ReportPrint(oReport)
    ...
    _cQ += "    (SELECT SUBSTR(VX5A.VX5_DESCRI,1,20) FROM " + RetSQLname("VX5") + " VX5A WHERE VX5A.VX5_CHAVE = 'Z00' AND VX5A.VX5_CODIGO = VS1.VS1_XTPPED AND VX5A.D_E_L_E_T_ = ' ' ) AS TIPO_PEDIDO, "
    _cQ += "    CASE "
