...
user function ZSAPF001( aParam )
	...
	IF lIsBlind
		...
		If !LockByName("ZSAPF001")
			Conout("JOB já em Execução : ZSAPF001 " + DTOC(dDATABASE) + " - " + TIME() )
			RpcClearEnv()
			Return
		EndIf
	EndIF
	...
	*/
	...
	while !(cAliasQry)->(Eof())
		...
		conout(" [SAP] [ZSAPF001] * * * * * Status da integracao * * * * *"									)
		conout(" [SAP] [ZSAPF001] Inicio.......................: " + cTimeIni + " - " + dToC( dDataBase ) 	)
		conout(" [SAP] [ZSAPF001] Fim..........................: " + cTimeFin + " - " + dToC( dDataBase ) 	)
		conout(" [SAP] [ZSAPF001] Tempo de Processamento.......: " + cTimeProc 								)
		conout(" [SAP] [ZSAPF001] URL..........................: " + cUrl									)
		conout(" [SAP] [ZSAPF001] HTTP Method..................: " + "GET" 									)
		conout(" [SAP] [ZSAPF001] Status Http (200 a 299 ok)...: " + allTrim( str( nStatuHttp ) ) 			)
		conout(" [SAP] [ZSAPF001] Retorno......................: " + allTrim( xPostRet ) 					)
		conout(" [SAP] [ZSAPF001] * * * * * * * * * * * * * * * * * * * * "									)
...
user function xZSAPF01(xParam1,xParam2,xParam3)

    U_ZSAPF001({{xParam1,xParam2,Val(xParam3)}})
