...
IF lIsBlind
	...
	If !LockByName("ZSAPF017")
		Alert("JOB já em Execução : ZSAPF017 " + DTOC(dDATABASE) + " - " + TIME() )
		RpcClearEnv()
		Return
	EndIf
EndIF
...
while !(cAliasNF)->(Eof())
	...
	*/	
	...
	Conout(" [SAP] [ZSAPF017] * * * * * Status da integracao * * * * *"									)
	Conout(" [SAP] [ZSAPF017] Inicio.......................: " + cTimeIni + " - " + dToC( dDataBase ) 	)
	Conout(" [SAP] [ZSAPF017] Fim..........................: " + cTimeFin + " - " + dToC( dDataBase ) 	)
	Conout(" [SAP] [ZSAPF017] Tempo de Processamento.......: " + cTimeProc 								)
	Conout(" [SAP] [ZSAPF017] URL..........................: " + cUrl									)
	Conout(" [SAP] [ZSAPF017] HTTP Method..................: " + "GET" 									)
	Conout(" [SAP] [ZSAPF017] Status Http (200 a 299 ok)...: " + allTrim( str( nStatuHttp ) ) 			)
	Conout(" [SAP] [ZSAPF017] Retorno......................: " + allTrim( xPostRet ) 					)
	Conout(" [SAP] [ZSAPF017] * * * * * * * * * * * * * * * * * * * * "									)
	...
	if nStatuHttp >= 200 .and. nStatuHttp <= 299
		...
		If (cAliasNF)->Z7_XOPESAP <> 2
			...
			xRet := oWsdl:SetValue( aSimple[nPos][1], _cEmpresa)	//empresa   =  SUBSTR(SE1->E1_FILIAL,1,4)
			If !xRet
...
user function xZSAPF17(xParam1,xParam2,xParam3)

U_ZSAPF017({{xParam1,xParam2,Val(xParam3)}})
