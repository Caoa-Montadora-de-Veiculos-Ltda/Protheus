...
If UPPER(Alltrim(CT2->CT2_ROTINA)) $ UPPER(cxRot)
	...
	If ((nOpc == 3 /*.or. nOpc == 4*/) .and. (IsInCallStack("U_DEPCTBGRV");
	    .or. IsInCallStack("U_DPCTB102GR"))) .or. ;
		((nOpc == 5 .or. nOpc == 6) .and. (IsInCallStack("U_ANTCTBGRV") .or. IsInCallStack("U_ANCTB102GR_PE")))
