...
user function ZSAPF002( aParam )
	...
	IF lIsBlind
		...
		If !LockByName("ZSAPF002")
			Conout("JOB já em Execução : ZSAPF002 " + DTOC(dDATABASE) + " - " + TIME() )
			RpcClearEnv()
			Return
		EndIf
	EndIF
	...
	*/
	...
	While !(cAliasQry)->(Eof())
		...
		conout(" [SAP] [ZSAPF002] * * * * * Status da integracao * * * * *")
		conout(" [SAP] [ZSAPF002] Inicio.......................: " + cTimeIni + " - " + dToC( dDataBase ) )
		conout(" [SAP] [ZSAPF002] Fim..........................: " + cTimeFin + " - " + dToC( dDataBase ) )
		conout(" [SAP] [ZSAPF002] Tempo de Processamento.......: " + cTimeProc )
		conout(" [SAP] [ZSAPF002] URL..........................: " + cUrl)
		conout(" [SAP] [ZSAPF002] HTTP Method..................: " + "GET" )
		conout(" [SAP] [ZSAPF002] Status Http (200 a 299 ok)...: " + allTrim( str( nStatuHttp ) ) )
		conout(" [SAP] [ZSAPF002] Retorno......................: " + allTrim( xPostRet ) )
		conout(" [SAP] [ZSAPF0012] * * * * * * * * * * * * * * * * * * * * ")
		//alert(nStatuHttp)
...
user function xZSAPF02(xParam1,xParam2,xParam3)

U_ZSAPF002({{xParam1,xParam2,Val(xParam3)}})
