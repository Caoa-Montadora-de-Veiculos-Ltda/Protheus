...
IF lIsBlind
	...
	If !LockByName("CMVSAP12")
		Alert("JOB já em Execução : CMVSAP12 " + DTOC(dDATABASE) + " - " + TIME() )
		RpcClearEnv()
		Return
	Else
		Conout("Conexão realizada com sucesso : CMVSAP12 " + DTOC(dDATABASE) + " - " + TIME() )
	EndIf
EndIF
