...
If aParam <> NIL
	...
	If cIdPonto == 'FORMCOMMITTTSPOS' 
		...
		IF ( ( AllTrim(FwCodEmp()) == "2020" .And. AllTrim(FwFilial()) == "2001" ) .Or. ( AllTrim(FwCodEmp()) == "9010" .And. AllTrim(FwFilial()) == "HAD1" ) )  .AND. !FWIsInCallStack("U_ZPECF023") //.AND. Substr(M->B1_COD,1,1) = "R" //somente Peças Barueri
