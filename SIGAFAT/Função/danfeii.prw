...
#DEFINE MAXVALORC  015					// Máximo de caracteres por linha de valores numéricos - Especifico CAOA
#DEFINE MAXCODPRD  075					// Máximo de caracteres do codigo de produtos/servicos conforme o tamanho do quadro "Cod. prod" - Especifico CAOA
...
If nTipo <> 1
	...
	If lIsLoja .Or. Upper(Alltrim(FunName())) == "ZPECF013" //************ Especifico Caoa 
		MV_PAR01 := SF2->F2_DOC
		MV_PAR02 := SF2->F2_DOC
